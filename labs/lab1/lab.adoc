...
. This lab will reference the $BOOTCAMP home directory, this is referring to the cf-spring-mvc-boot directory from this repo. Either download the zip for the repo, or clone it.
